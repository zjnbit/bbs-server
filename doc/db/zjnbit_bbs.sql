...
-- ----------------------------
BEGIN;
INSERT INTO `auth_permission` (`id`, `group_id`, `permission_code`, `permission_name`, `permission_path`,
                               `permission_remark`, `create_user`, `create_time`, `update_user`, `update_time`,
                               `version`, `is_deleted`)
VALUES (1495680647895826434, 1495680382488657922, 'role-add', '添加角色', '/admin/role/add', '添加角色',
        1481796949110722562, '2022-02-21 16:43:50', 1481796949110722562, '2022-02-21 16:43:50', 1, 0);
INSERT INTO `auth_permission` (`id`, `group_id`, `permission_code`, `permission_name`, `permission_path`,
                               `permission_remark`, `create_user`, `create_time`, `update_user`, `update_time`,
                               `version`, `is_deleted`)
VALUES (1495680987730808834, 1495680382488657922, 'permission-add', '添加权限', '/admin/permission/add', '添加权限',
        1481796949110722562, '2022-02-21 16:45:11', 1481796949110722562, '2022-02-21 16:45:11', 1, 0);
INSERT INTO `auth_permission` (`id`, `group_id`, `permission_code`, `permission_name`, `permission_path`,
                               `permission_remark`, `create_user`, `create_time`, `update_user`, `update_time`,
                               `version`, `is_deleted`)
VALUES (1495681072694824962, 1495680382488657922, 'permission-addGroup', '添加权限组', '/admin/permission/addGroup',
        '添加权限组', 1481796949110722562, '2022-02-21 16:45:31', 1481796949110722562, '2022-02-21 16:45:31', 1, 0);
INSERT INTO `auth_permission` (`id`, `group_id`, `permission_code`, `permission_name`, `permission_path`,
                               `permission_remark`, `create_user`, `create_time`, `update_user`, `update_time`,
                               `version`, `is_deleted`)
VALUES (1495683648790208513, 1495680382488657922, 'role-get', '获取单个角色', '/admin/role/get', '获取单个角色',
        1481796949110722562, '2022-02-21 16:55:45', 1481796949110722562, '2022-02-21 16:55:45', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_permission_group` (`id`, `group_name`, `group_remark`, `create_user`, `create_time`, `update_user`,
                                     `update_time`, `version`, `is_deleted`)
VALUES (1495680382488657922, 'default', '默认分组', 1481796949110722562, '2022-02-21 16:42:46', 1481796949110722562,
        '2022-02-21 16:42:46', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_role` (`id`, `role_code`, `role_name`, `create_user`, `create_time`, `update_user`, `update_time`,
                         `version`, `is_deleted`)
VALUES (1495666350796849154, 'root', '超级管理员', 0, '2022-02-21 15:47:01', 0, '2022-02-21 15:47:01', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_role_permission` (`id`, `role_id`, `permission_id`, `create_user`, `create_time`, `update_user`,
                                    `update_time`, `version`, `is_deleted`)
VALUES (1495682889189187585, 1495666350796849154, 1495680647895826434, 1481796949110722562, '2022-02-21 16:52:44',
        1481796949110722562, '2022-02-21 16:52:44', 1, 0);
INSERT INTO `auth_role_permission` (`id`, `role_id`, `permission_id`, `create_user`, `create_time`, `update_user`,
                                    `update_time`, `version`, `is_deleted`)
VALUES (1495682890355204097, 1495666350796849154, 1495680987730808834, 1481796949110722562, '2022-02-21 16:52:44',
        1481796949110722562, '2022-02-21 16:52:44', 1, 0);
INSERT INTO `auth_role_permission` (`id`, `role_id`, `permission_id`, `create_user`, `create_time`, `update_user`,
                                    `update_time`, `version`, `is_deleted`)
VALUES (1495682890397147138, 1495666350796849154, 1495681072694824962, 1481796949110722562, '2022-02-21 16:52:44',
        1481796949110722562, '2022-02-21 16:52:44', 1, 0);
INSERT INTO `auth_role_permission` (`id`, `role_id`, `permission_id`, `create_user`, `create_time`, `update_user`,
                                    `update_time`, `version`, `is_deleted`)
VALUES (1495683761440825345, 1495666350796849154, 1495683648790208513, 1481796949110722562, '2022-02-21 16:56:12',
        1481796949110722562, '2022-02-21 16:56:12', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `auth_user_role` (`id`, `user_id`, `role_id`, `create_user`, `create_time`, `update_user`, `update_time`,
                              `version`, `is_deleted`)
VALUES (1495669595694964738, 1641433038623604737, 1495666350796849154, 1481796949110722562, '2022-02-21 15:59:55',
        1481796949110722562, '2022-02-21 15:59:55', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bbs_node_group` (`id`, `group_name`, `remark`, `sort`, `create_user`, `create_time`, `update_user`,
                              `update_time`, `version`, `is_deleted`)
VALUES (1564186782705143809, 'code', '编程', 1, 1560475574944722946, '2022-08-29 17:42:45', 1560475574944722946,
        '2022-08-31 13:58:22', 1, 0);
INSERT INTO `bbs_node_group` (`id`, `group_name`, `remark`, `sort`, `create_user`, `create_time`, `update_user`,
                              `update_time`, `version`, `is_deleted`)
VALUES (1564190136395141122, 'work', '工作', 2, 1560475574944722946, '2022-08-29 17:56:04', 1560475574944722946,
        '2022-08-29 17:56:04', 1, 0);
INSERT INTO `bbs_node_group` (`id`, `group_name`, `remark`, `sort`, `create_user`, `create_time`, `update_user`,
                              `update_time`, `version`, `is_deleted`)
VALUES (1564190165302284290, 'game', '游戏', 2, 1560475574944722946, '2022-08-29 17:56:11', 1560475574944722946,
        '2022-08-29 17:56:11', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431640039426, 'aliyun:security:access-key', '123456', 1481796949110722562, '2022-02-21 16:43:50',
        1481796949110722562, '2022-02-21 16:43:50', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431723925505, 'aliyun:security:access-key-secret', '123456', 1481796949110722562, '2022-02-21 16:45:11',
        1481796949110722562, '2022-02-21 16:45:11', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431779823618, 'aliyun:oss:bucket', 'zjnbit', 1481796949110722562, '2022-02-21 16:45:31',
        1481796949110722562, '2022-02-21 16:45:31', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431786840065, 'aliyun:oss:endpoint', 'oss-cn-hongkong.aliyuncs.com', 1481796949110722562,
        '2022-02-21 16:55:45', 1481796949110722562, '2022-02-21 16:55:45', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431818543106, 'aliyun:oss:bucket-url', 'abc.oss-cn-hongkong.aliyuncs.com', 1481796949110722562,
        '2022-02-21 16:45:11', 1481796949110722562, '2022-02-21 16:45:11', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431876292609, 'aliyun:oss:cdn-url', 'abc.abc.com', 1481796949110722562, '2022-02-21 16:45:31',
        1481796949110722562, '2022-02-21 16:45:31', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1554036431902429185, 'aliyun:oss:callback-url', 'https://bbs.abc.com/api/callback/oss/aliyun',
        1481796949110722562, '2022-02-21 16:55:45', 1481796949110722562, '2022-02-21 16:55:45', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1560431909987777561, 'auth:secret:aes-key', '123456', 1481796949110722562, '2022-08-19 09:03:14',
        1481796949110722562, '2022-08-19 09:03:14', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1560431909987778561, 'auth:cas:client-id', '123456', 1481796949110722562, '2022-08-19 09:04:14',
        1481796949110722562, '2022-08-19 09:04:14', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1560432243307655170, 'auth:cas:client-secret', '123456', 1481796949110722562, '2022-08-19 09:04:14',
        1481796949110722562, '2022-08-19 09:04:14', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1560436488048160770, 'auth:cas:server-url', 'https://auth.abc.com', 1481796949110722562, '2022-08-19 09:04:14',
        1481796949110722562, '2022-08-19 09:04:14', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1575322518842699777, 'bbs:topic:post-status-default', 'open', 1481796949110722562, '2022-09-29 11:13:47',
        1481796949110722562, '2022-09-29 11:13:51', 1, 0);
INSERT INTO `bbs_sys_conf` (`id`, `conf_key`, `conf_value`, `create_user`, `create_time`, `update_user`, `update_time`,
                            `version`, `is_deleted`)
VALUES (1575356982457200641, 'bbs:node:post-can-anonymous', '1', 1481796949110722562, '2022-09-29 13:30:48',
        1481796949110722562, '2022-09-29 13:30:52', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bbs_sys_dict` (`id`, `dict_name`, `dict_key`, `dict_value`, `dict_remark`, `create_user`, `create_time`,
                            `update_user`, `update_time`, `version`, `is_deleted`)
VALUES (1562325777530957826, 'userbase:sex', 'm', '男', '性别:男', 1560475574944722946, '2022-08-24 14:30:22',
        1560475574944722946, '2022-08-24 14:30:22', 1, 0);
INSERT INTO `bbs_sys_dict` (`id`, `dict_name`, `dict_key`, `dict_value`, `dict_remark`, `create_user`, `create_time`,
                            `update_user`, `update_time`, `version`, `is_deleted`)
VALUES (1562325785350602753, 'userbase:sex', 'f', '女', '性别:女', 1560475574944722946, '2022-08-24 14:30:22',
        1560475574944722946, '2022-08-24 14:30:22', 1, 0);
INSERT INTO `bbs_sys_dict` (`id`, `dict_name`, `dict_key`, `dict_value`, `dict_remark`, `create_user`, `create_time`,
                            `update_user`, `update_time`, `version`, `is_deleted`)
VALUES (1562325785367379969, 'userbase:sex', 'n', '未知', '性别:未知', 1560475574944722946, '2022-08-24 14:30:22',
        1560475574944722946, '2022-08-24 14:30:22', 1, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user_base` (`id`, `mobile`, `email`, `username`, `password`, `nickname`, `gender`, `avatar`, `score`,
                         `status`, `level`, `is_activated`, `create_user`, `create_time`, `update_user`, `update_time`,
                         `version`, `is_deleted`)
VALUES (1641433038623604737, NULL, '376102636@qq.com', 'root',
        '$2a$10$6Es0WbA1VlOVQ39iMWcZcOlP4DGpTrMRBSERXR3CkyxbH.SP3O79G', 'root', 'N',
        'https://oss.zjnbit.com/static/default_avatar.jpeg', 0, 'normal', 'normal', 0, 0, '2023-03-30 21:31:47', 0,
        '2023-03-30 21:31:47', 1, 0);
COMMIT;
